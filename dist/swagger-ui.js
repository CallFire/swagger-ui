...
function program1(depth0,data) {
  ...
  buffer += "    \n    <div class=\"row-fluid\">\n        <div id='sidebar' class=\"span3\">\n            <ul id='sidebar_resources' class='nav nav-pills nav-stacked'>\n            </ul>\n        </div>\n\n        <div class='container span9' id='resources_container'>\n            <ul id='resources'>\n            </ul>\n\n            <div class=\"footer\">\n                <br>\n                <br>\n                <h4 style=\"color: #999\">[ <span style=\"font-variant: small-caps\">base url</span>: ";
...
function program5(depth0,data) {
  ...
  return "\n                    <h4>Parameters</h4>\n                    <table class='fullwidth'>\n                        <thead>\n                        <tr>\n                            <th>Parameter</th>\n                            <th style='width: 33%; max-width: 33%'>Value</th>\n                            <th>Description</th>\n                            <th>Parameter Type</th>\n                            <th>Data Type</th>\n                        </tr>\n                        </thead>\n                        <tbody class=\"operation-params\">\n\n                        </tbody>\n                    </table>\n                    ";
  }
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\" onclick=\"Docs.toggleOperationContent('";
  if (stack1 = helpers.resourceName) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.resourceName; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "', '";
  ...
  buffer += escapeExpression(stack1)
    + "' class='toggle-icon'><i class='icon-chevron-right'></i> /";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "</a>\n<ul class='sidebar_endpoints nav nav-pills nav-stacked' id='";
  if (stack1 = helpers.name) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "_endpoint_list' style='display: none;'>\n    ";
  stack1 = helpers.each.call(depth0, depth0.operationsArray, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</ul>\n";
  return buffer;
  });
...
(function() {
  var ContentTypeView, HeaderView, MainView, OperationView, ParameterView, ResourceView, SidebarView, SignatureView, StatusCodeView, SwaggerUi,
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.render = function() {
      var resource, sidebar, _i, _j, _len, _len1, _ref, _ref1, _results;
      ...
      _ref1 = this.model.apisArray;
      _results = [];
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        sidebar = _ref1[_j];
        _results.push(this.addSidebar(sidebar));
      }
      return _results;
    };
    ...
    MainView.prototype.addSidebar = function(sidebar) {
      var sidebarView;
      sidebarView = new SidebarView({
        model: sidebar,
        tagName: 'li',
        id: 'sidebar_' + sidebar.name,
        className: 'sidebar_item'
      });
      return $('#sidebar_resources').append(sidebarView.render().el);
    };
  ...
  SidebarView = (function(_super) {
    ...
    SidebarView.prototype.render = function() {
      $(this.el).html(Handlebars.templates.sidebar(this.model));
      return this;
    };

    SidebarView.prototype.toggleSidebar = function(e) {
      var elem;
      console.log(e.target);
      elem = $(e.target);
      if (elem.hasClass('icon-chevron-right') || elem.hasClass('icon-chevron-down')) {
        if (elem.hasClass('icon-chevron-right')) {
          elem.removeClass('icon-chevron-right').addClass('icon-chevron-down');
          return elem.parent().siblings('ul.sidebar_endpoints').slideDown();
        } else {
          elem.removeClass('icon-chevron-down').addClass('icon-chevron-right');
          return elem.parent().siblings('ul.sidebar_endpoints').slideUp();
        }
      } else {
        if (elem.children('i').hasClass('icon-chevron-right')) {
          elem.children('i').removeClass('icon-chevron-right').addClass('icon-chevron-down');
          return elem.siblings('ul.sidebar_endpoints').slideDown();
        } else {
          elem.children('i').removeClass('icon-chevron-down').addClass('icon-chevron-right');
          return elem.siblings('ul.sidebar_endpoints').slideUp();
        }
      }
    };
